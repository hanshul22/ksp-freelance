...
const ContactFormSection = () => {
  ...
  return (
    <section ref={containerRef} className="py-24 bg-white contact-section">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-8">
            ...
            <form className="space-y-6">
              ...
              <div className="form-row">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg text-gray-700 placeholder-gray-400 focus:outline-none focus:border-[#1E88E5] focus:ring-1 focus:ring-[#1E88E5] bg-white transition-shadow duration-200 focus:shadow-sm"
                  />
                </div>
              </div>
              ...
              <div className="form-row">
                ...
                <div className="relative group">
                  ...
                  <textarea
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg text-gray-700 placeholder-gray-400 focus:outline-none focus:border-[#1E88E5] focus:ring-1 focus:ring-[#1E88E5] resize-none bg-white transition-shadow duration-200 focus:shadow-sm"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                className="submit-button w-full bg-[#1E88E5] hover:bg-[#1976D2] text-white font-semibold py-3.5 rounded-lg flex items-center justify-center gap-2 transition-colors duration-300 active:translate-y-[1px]"
