    ...
    <section className="py-0 md:py-24">
      <div className="px-4 mx-auto max-w-7xl md:px-8">
        ...
        <div className="relative block md:hidden">
          ...
          <div className="absolute top-0 left-0 right-0 overflow-hidden -z-10" style={{ height: '600px' }}>
            <svg 
              viewBox="0 0 375 600" 
              fill="none" 
          ...
          <div className="relative z-10 flex flex-col items-center px-6 pt-4 pb-12 text-center">
            {/* Label */}
            <span className="mb-6 text-[13px] font-bold tracking-wider text-blue-600 uppercase">
              About KSP Hydro Engineers
            </span>

            {/* Heading - Larger and bolder */}
            <h2 className="text-[2.25rem] font-bold leading-[1.2] text-gray-900 mb-6 max-w-sm">
              Practical Water Solutions for Real-World Needs
            </h2>

            {/* Description - Larger text */}
            <p className="text-[16px] leading-relaxed text-slate-600 max-w-sm mb-8">
            ...
            <Link
              to="/about"
              className="inline-flex items-center gap-2 px-6 py-3 text-[15px] text-blue-600 transition-all bg-white border-2 border-blue-600 rounded-xl font-semibold hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 mb-10"
            >
              Know More About Us
