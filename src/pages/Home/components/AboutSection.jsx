      ...
      <div className="px-4 mx-auto max-w-7xl md:px-8">
        ...
        <div className="relative block md:hidden">
          ...
          <div className="relative z-10 flex flex-col items-center px-4 py-8 text-center">
            ...
            <Link
              to="/about"
              className="inline-flex items-center gap-3 px-6 py-2.5 text-[#155DFC] bg-white border border-[#155DFC]/40 rounded-full text-sm font-medium hover:bg-blue-50/50 focus:outline-none"
            >
              Know More About Us
