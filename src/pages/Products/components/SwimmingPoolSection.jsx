...
const SwimmingPoolSection = () => {
  return (
    <section className="relative bg-[#F2FAFD] py-20 overflow-hidden">
      {/* Decorative shapes */}
      <div className="absolute top-0 left-0 w-72 h-72 bg-[#E0F4FB] rounded-full -translate-x-1/2 -translate-y-1/2 opacity-60" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#E0F4FB] rounded-full translate-x-1/3 translate-y-1/3 opacity-60" />
